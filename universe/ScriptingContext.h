...
struct ScriptingContext {
    ...
    /** Context with source and combat context. We use this in combat resolution 
    ...
    ScriptingContext(std::shared_ptr<const UniverseObject> source_,
                     const AutoresolveInfo& combat_context_) :
        source(source_),
        combat_context(combat_context_)
    {}
    ...
    ScriptingContext(const ScriptingContext& parent_context,
        ...
        current_value(current_value_),
        combat_context(parent_context.combat_context)
    {}
    ...
    AutoresolveInfo                         combat_context;
};
